...
# -*- coding: utf-8 -*-
"""
Created on Tue May  3 17:38:34 2022
...
# path_kw = '/treelet_rbf_krr/atom_bond_types/std_y/'
path_kw = '/treelet_rbf_krr/1hot/'
...
# 		}))
	# for no scaling:
	hparams = list(ParameterGrid({
		'gamma': [1e-7, 5e-7, 1e-6, 5e-6, 1e-5, 5e-5, 1e-4, 5e-4, 0.001, 0.005, 0.01, 0.05, 0.1],
		'alpha': [0.05, 0.1, 0.5, 1, 5, 10]
		}))
