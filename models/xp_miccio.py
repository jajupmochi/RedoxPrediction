...
DICTIONARY_USED = DICTIONARY2 # @todo: change according to dataset.
...
# 	test_accuracy = mean_absolute_error(y_test, y_pred_test)
	...
	return train_accuracy, valid_accuracy, test_accuracy, model
...
# 		print("{0} Mode".format(setup))
		...
		perf_train, perf_valid, perf_test, model = evaluate_model(
...
# 	test_losses()
	...
	### Load dataset.
	for ds_name in ['poly200+sugarmono']: # ['poly200+sugarmono']: ['poly200'] #  : ValueError: 'H' is not in list,
