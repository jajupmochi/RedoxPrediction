...
from redox_prediction.models import Identity
from redox_prediction.models import GlobalAverageMaxPooling1D, GlobalAveragePooling1D, GlobalMaxPooling1D
...
def prepare_batch(x_batch, y_batch, kernel_type='custom'):
	...
	num_edges = pair_indices.row_lengths() # edge_features may be empty.s
